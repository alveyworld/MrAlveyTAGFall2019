...
__author__ = "21talboraer@washk12.org"
__title__ = "Alvey World"
...
Records:
 ...
 Player:
   ...
   state (dict[bool:Hungry,bool:Sanity, int:money]): The current health and wealth
   status of player
 Location:
   ...
   people (list[persons]): A list of persons at a location
   person:
